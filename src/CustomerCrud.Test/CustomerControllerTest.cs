...
public class CustomersControllerTest : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    {
        var customers = AutoFaker.Generate<Customer>(4);
    ...
    public async Task CreateTest()
    {
        ...
        _repositoryMock.Verify(r => r.GetNextIdValue(), Times.Once); _repositoryMock.Verify(r => r.Create(It.Is<Customer>(r => r.Id == 1)), Times.Once);
    }
